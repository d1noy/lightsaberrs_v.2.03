...
TREE.Name = "Sith Guard"

--Description of the skill tree
TREE.Description = "Обезопасить Императора!"

--Icon for the skill tree ( Appears in category menu and above the skills )
TREE.TreeIcon = "materials/alpha/1498371469_54444134.png"



TREE.JobRestricted = { "TEAM_GRAND", "TEAM_AGENTG", "TEAM_AGENTGG", "TEAM_GVARD", "TEAM_GVARDD", "TEAM_LORD", "TEAM_DART", "TEAM_PREDSI", "TEAM_IMPERATOR", "TEAM_MALAK", "TEAM_MALGUS", "TEAM_BENDON", "TEAM_SION", "TEAM_REVAN", "TEAM_NIHILUS", "TEAM_ORDEN1", "TEAM_ORDEN2", "TEAM_ORDEN3", "TEAM_ORDEN4", "TEAM_ORDEN5", "TEAM_ORDEN6", "TEAM_ORDEN7", "TEAM_ORDEN8", "TEAM_ORDEN9", "TEAM_ORDEN10", "TEAM_ORDEN11", "TEAM_ORDEN12", "TEAM_ORDEN13", "TEAM_ORDEN14", "TEAM_ORDEN15", "TEAM_ORDEN16", "TEAM_ORDEN17", "TEAM_ORDEN18", "TEAM_ORDEN19"}
